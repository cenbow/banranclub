...
@Controller("selectTRoleAction")
@Scope("prototype")
public class SelectTRoleAction extends BaseAction {
	...
	public String execute() throws Exception {
		try {
			this.getRequest().setAttribute("tRoleQueryBean",tRoleQueryBean);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public String getListData() {
		...
		try {
			...
			for (Map d : rows) {
				...
				d.put("RESOURCE_CONFIG","<a href='javascript:return void(0);' onClick=\"tRole_list.allotResourceFormSubmit('"+ d.get("ROLE_ID")+ "','"+d.get("ROLE_NAME")+"','"+d.get("ROLE_GROUP")+"');return false;\"><i class='icon-edit'></i></a>");
				d.put("USER_CONFIG","<a href='javascript:return void(0);' onClick=\"tRole_list.allotResourceFormSubmit('"+ d.get("ROLE_ID")+ "','"+d.get("ROLE_NAME")+"','"+d.get("ROLE_GROUP")+"');return false;\"><i class='icon-edit'></i></a>");
           		}
