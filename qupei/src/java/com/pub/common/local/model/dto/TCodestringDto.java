...
public class TCodestringDto extends BaseDtoImpl{//
	private String cs_code;//参数代码
	private String cs_type;//参数类型
	private String cs_sub_type;//参数类型项下的子类值,应用可依次进行加载
	private String cs_name;//参数名称
	private String cs_value;//参数值
	private String cs_desc;//参数描述
	...
	* @param cs_sub_type
	*/
 	public void setCs_sub_type(String cs_sub_type) {
