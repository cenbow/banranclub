...
<div class="content-body">
	<div class="search-panel toggle-panel">
		<div class="search-panel-content">
			<form id="addTPlatformempCfgFrom" name="addTPlatformempCfgFrom" method="post" action="addTPlatformempCfgAction.action">
...
tConfig_list.trigger = function(){
	...
	tConfig_list.buildQueryParams=function(){
	    $('div#div_userRole_list #dg_tCodestring').datagrid('options')
			.queryParams = {
				'tUserRoleRelaQueryBean.user_id':$("#div_userRole_list input[name='tUserRoleRelaDto.user_id']").val()
			};
	};
	...
	$('div#div_userRole_list #remove_resource_role_btn').click(function(){
   		...
   		$.post("delTRoleResRelaAction.action",
   		  {
   		  	"tRoleResRelaDto.res_id": $('div#div_userRole_list #res_id').val(),
	...
	//datagrid初始化
	$('div#content-body #dg_tCodestring').datagrid({
		sortOrder:'desc',
		pagination:'true',
		url:'<%=pathUrl%>/searchTPlatformempCfgAction!getListData.action',
		method:'post',
		queryParams: {//
			//'tPlatformempCfgDto.platform_id':$("#content-body #platform_id").val()
			'platform_id':$("#content-body #platform_id").val()
