...
missingMessage:'请填写此值'
						...
						<tr>
							...
							<td>select</td>
							<td>
								<p><strong>行内属性调用：</strong><br/>
<pre>
required="true" 
validType="select['#selector']"
...
missingMessage:'请填写此值'
							...
							<td>option 的value 不能为空</td>
							<td>
								<div style="color:#cc0000;">
								特别说明：统一约束写法为&lt;select required="true" validType="select['#selector']" invalidMessage="该值不能为空" missingMessage="请填写此值"     &gt;&lt;option value=""&gt;请选择&lt;/option&gt;&lt;/select&gt;
								必须使用属性声明的方式  data-options 目前看来无效
								</div>
							</td>
							<td>
								<p>校验select：<br/>
									<select id="chenjia" class="easyui-combobox" required="true" 
									validType="select['#chenjia']"
									invalidMessage="该值不能为空" 
									missingMessage="请填写此值">
...
data-options="
required:true,
validType:'numberNotAfter[\'number1\']',
...
missingMessage:'请填写此值'
							...
							<td>
								<p>number1：<br/><input id="number1" type="text" class="easyui-validatebox" data-options="required:true,validType:'numberNotAfter[\'#number2\']', invalidMessage:'数值不能大于number2',missingMessage:'请填写此值'" /></p>
...
data-options="
required:true,
validType:'numberNotBefore[\'number2\']',
...
missingMessage:'请填写此值'
							...
							<td>
								<p>number2：<br/><input id="number2" type="text" class="easyui-validatebox" data-options="required:true,validType:'numberNotBefore[\'#number1\']', invalidMessage:'数值不能小于number1',missingMessage:'请填写此值'" /></p>
