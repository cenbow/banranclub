...
<body onload="backToCaifuNc()">
	...
	<input  id="backToCaifuNc"  name="backToCaifuNc" type="button" value="返回财富农场" onclick="backToCaifuNc()" />	
	-->	
</body>
<script type="text/javascript">
   	
   	function backToCaifuNc(){
   		//alert(1111111);
   		window.location.href = 'http://farmfortune.com/ecwap/#account/wxbindresult';
   	}
