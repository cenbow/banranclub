	...
	<article id="content" class="content">
		<div class="content-body">
			...
			<div class="result-content">
				<table  id="dg_tCodestring" class="easyui-datagrid" title="xx员工配置角色查询结果" style="width:auto;height:300px"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'EDIT',width:150,align:'center'">角色ID</th>
							<th data-options="field:'CS_CODE',width:200,sortable:'true',align:'right'">角色名称</th>
							<th data-options="field:'CS_TYPE',width:150,sortable:'true',align:'right'">标识组</th>
							<th data-options="field:'CS_SUB_TYPE',width:150,sortable:'true',align:'right'">创建人</th>
