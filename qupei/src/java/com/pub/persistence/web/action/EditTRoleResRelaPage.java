...
@Controller("editTRoleResRelaPage")
@Scope("prototype")
public class EditTRoleResRelaPage extends BaseAction {
	...
	public final void setTRoleResRelaDto(TRoleResRelaDto tRoleResRelaDto) {
