...
<div class="message-wrapper">
	<div class="message-content">
		...
		<span class="message-text">您没有权限执行此操作,请联系管理员,谢谢!</span>
	</div>
</div>
<p style="text-align:center; margin-top:15px; font-size:14px; margin-bottom:10px;"><span id="timer">5</span>秒后跳转到登录页..., </p>
