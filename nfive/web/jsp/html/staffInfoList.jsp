	...
	<article id="content" class="content">
		<div class="content-body">
						...
						<div class="search-panel-bd">
							<table class="search-table">
								 ...
								 <tr>
										...
										<th class="wd-20"><label>组织结构</label></th>
										<td>
			...
			<div class="result-content">
				<table  id="dg_tCodestring" class="easyui-datagrid" title="员工信息查询结果" style="width:auto;height:300px"
					...
					<thead>
						<tr>
						 	<th data-options="field:'DETAIL',width:150,align:'center'">详细</th>
							<th data-options="field:'EDIT',width:150,align:'center'">编辑</th>
							<th data-options="field:'CS_CODE',width:200,sortable:'true',align:'right'">角色配置</th>
							<th data-options="field:'CS_TYPE',width:150,sortable:'true',align:'right'">员工CD</th>
							<th data-options="field:'CS_SUB_TYPE',width:150,sortable:'true',align:'right'">组织结构</th>
							<th data-options="field:'CS_NAME',width:150,sortable:'true',align:'right'">手机</th>
							<th data-options="field:'CS_VALUE',width:150,sortable:'true',align:'right'">邮件</th>
							<th data-options="field:'CS_VALUE',width:150,sortable:'true',align:'right'">创建人</th>
							<th data-options="field:'CS_VALUE',width:150,sortable:'true',align:'right'">创建时间</th>
							<th data-options="field:'CS_VALUE',width:150,sortable:'true',align:'right'">更新人</th>
