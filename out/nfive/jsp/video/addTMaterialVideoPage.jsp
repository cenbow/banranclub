...
<div class="content-body">
	<div class="search-panel toggle-panel">
		<div class="search-panel-content">
			<form id="addTMaterialVideoFrom" name="addTMaterialVideoFrom" method="post" action="addTMaterialVideoAction.action" enctype="multipart/form-data">
				<div class="search-panel-bd">
				 <table class="search-table">
						 <tr>
							<th class="wd-15"><label>视频名称</label><span class="stRed">*</span></th>
							<td>
								<input type="text" id="tMaterialVideoDto_video_name" class="easyui-validatebox" name="in_tMaterialVideoDto.video_name" maxlength="50" data-options="validType:'length[0,50]',required:true,invalidMessage:'视频名称不能超过50个字符',missingMessage:'视频名称不能为空'" style="width:200px;" />
							</td>
							<th class="wd-15"><label>是否缓存</label><span class="stRed">*</span></th>
							<td>
								<ldui:select items="${cache_flag_Select}" id="add_is_cache_Select" name="in_tMaterialVideoDto.cache_flag" class="easyui-combobox" value="${out_tMaterialVideoDto.cache_flag}"
									required="true" validType="select['#add_is_cache_Select']" invalidMessage="是否缓存不能为空" missingMessage="请填写是否缓存" style="width:200px;" />
							</td>
						  </tr>
						 <tr>
							<th class="wd-15"><label>视频描述</label></th>
							<td colspan="3">
								<textarea  class="easyui-validatebox" style="width:577px; max-width: 610px;max-height: 50px;height: 30px;" id="tMaterialVideoDto_video_desc" name="in_tMaterialVideoDto.video_desc"  data-options="validType:'length[0,100]',invalidMessage:'视频描述不能超过100个字符！'"></textarea>
							</td>
						  </tr>
						   <tr>
						 ...
						 <tr>
							<td colspan="2" style="height: 220px;">
							 	<s:file theme="simple"  id="videoFile" name="videoFile" onchange="setVideoPreview();" ></s:file><br /><label style="float: right;margin-right: 5px;">视频文件限制：格式只能为mp4/MP4，大小不超过10M</label></br>
...
function setVideoPreview() {  
	...
	function setThumbPreview() {  
    	...
    	if(docObj.files && docObj.files[0]){ 	
    		...
    		$('#localThumb').panel({
				content:'<img id="img" alt="图片不能正常显示" src="'+src+'" width="200" height="200"></img>'
			}); 
    	}else{  
