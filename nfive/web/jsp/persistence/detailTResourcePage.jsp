		...
		<div class="search-panel-bd">
			<table class="search-table">
				...
				<tr>
					...
					<td>
						<input type="text" id="tCodestringDto.cs_name"
				...
				<tr>
					...
					<td colspan="3">
						<textarea readonly="readonly" id="tResourceDto.res_desc"
							name="tResourceDto.res_desc" class="easyui-validatebox" value="">${tResourceDto.res_desc}</textarea>
					</td>
				</tr>
			</table>
		</div>
