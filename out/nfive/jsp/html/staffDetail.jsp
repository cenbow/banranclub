		...
		<div class="search-panel-bd">
			<table class="search-table">
				 <tr>
						...
						<td>
							<input type="text" id="tCodestringDto.cs_sub_type" name="search_cs_sub_type" value="" disabled style="width:200px;" />
						</td>
				  </tr>
				 <tr>
						<th class="wd-20"><label>密码</label></th>
						<td>
							<input type="text" id="tCodestringDto.cs_name" name="search_cs_name" value="" disabled style="width:200px;" />
						</td>
						<th class="wd-20 vt"><label>邮箱</label></th>
						<td>
							<input type="text" id="tCodestringDto.cs_value" name="search_cs_value" value="" disabled style="width:200px;" />
						</td>
				</tr>
				<tr>
				 ...
				 <tr>
					...
					<td colspan="3">
						<textarea name="search_cs_name" disabled></textarea>
					</td>
			   </tr>
			</table>
		</div>
